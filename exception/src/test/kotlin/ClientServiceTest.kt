...
class ClientServiceTest {
    ...
    @Test
    fun `fail save client - snils validation error - invalid length`() {
    ...
    @Test
    fun `fail save client - snils validation error - invalid check sum`() {
        val client = getClientFromJson("/fail/user_with_bad_snils2.json")
        val exception = assertFailsWith<ValidationException>("Ожидаемая ошибка") {
            clientService.saveClient(client)
        }
        assertEquals(exception.errorCode[0], ErrorCode.INVALID_CHECK_SUM)
    }
